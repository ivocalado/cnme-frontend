...
titulo: string = "Projetos Entregues"
  ...
  fetchProjetos(pageSize: number, pageIndex: number) {
    ...
    .getProjetosPorStatus("ENTREGUE", pageSize, pageIndex)
        .subscribe((res: any) => {
